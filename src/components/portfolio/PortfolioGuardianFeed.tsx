              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 my-4">
                  ...
                  <div className="bg-[#FFF8EE] border border-[#F7E5C8] rounded-xl p-3.5">
                    ...
                    <p className={`text-xs text-[#63451B] leading-relaxed ${getLanguageFontClass(preferredLanguage)}`}>
                      {translateExplanation(alert.reasoningChain.cause, preferredLanguage)}
                    </p>
                  </div>
                  ...
                  <div className="bg-[#FFF8EE] border border-[#F7E5C8] rounded-xl p-3.5">
                    ...
                    <p className={`text-xs text-[#63451B] leading-relaxed ${getLanguageFontClass(preferredLanguage)}`}>
                      {translateExplanation(alert.reasoningChain.mechanism, preferredLanguage)}
                    </p>
                  </div>
                  ...
                  <div className="bg-[#FDF2F2] border border-[#FCA5A5] rounded-xl p-3.5">
                    ...
                    <p className={`text-xs text-[#7F1D1D] leading-relaxed font-medium ${getLanguageFontClass(preferredLanguage)}`}>
                      {translateExplanation(alert.reasoningChain.impact, preferredLanguage)}
                    </p>
                  </div>
