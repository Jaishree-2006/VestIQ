...
export const INITIAL_HOLDINGS: HoldingItem[] = [
  ...
  },
  {
    ...
    brokerage_pct: 0.0,
    causalChain: {
      cause: 'Active multi-cap equity fund allocation',
      mechanism: 'Global & domestic equity exposure',
      impact: 'Capital growth with active management fee drag'
    }
  }
];
